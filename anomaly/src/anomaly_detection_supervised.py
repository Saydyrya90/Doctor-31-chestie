...
# joblib.dump(model, "model_supervised.pkl")  # MOVED to streamlit_app.py within get_or_train_ai_model_cached
# joblib.dump(scaler, "scaler_supervised.pkl") # MOVED to streamlit_app.py within get_or_train_ai_model_cached

# print("✅ Modelul și scalerul au fost salvați cu succes.") # This print is also only relevant if run directly
